...
namespace Assignment_API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        {
            var tokenFile =  @"X:\test\BD-Assignment\Assignment_API\files\token.json";
            var credentialsFile =  @"X:\test\BD-Assignment\Assignment_API\files\client_secret.json";
            ...
            var options = new RestClientOptions("https://oauth2.googleapis.com/token") {
